...
class PictureController extends WidgetsBindingObserver {
    ...
    _createDummy() {
        ...
        _pictures.add(new Picture(path: "https://img.youtube.com/vi/UOmolLOQ7Rs/0.jpg", user: "PRODUCE 48", userIcon: "https://yt3.ggpht.com/-AsxbpxU0yYY/AAAAAAAAAAI/AAAAAAAAAAA/fn7jpICg8xQ/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg"));
        ...
        _pictures.add(new Picture(path: "https://img.youtube.com/vi/xRbPAVnqtcs/0.jpg", user: "볼빨간 사춘기", ));
        _pictures.add(new Picture(path: "https://img.youtube.com/vi/BQ0mxQXmLsk/0.jpg", user: "Camila Cabello", userIcon: "https://yt3.ggpht.com/-DomRSSKWuyU/AAAAAAAAAAI/AAAAAAAAAAA/X8VIozIGQJQ/s288-mo-c-c0xffffffff-rj-k-no/photo.jpg"));
        ...
        _pictures.add(new Picture(path: "https://img.youtube.com/vi/0wlXaHmmOVc/0.jpg", user: "나얼", userIcon: "http://image.chosun.com/sitedata/image/201805/02/2018050201511_0.jpg"));
